...
public class RecipeInputEnchantedBook implements IRecipeInput {
    ...
    public boolean matches(ItemStack stack) {
        if (validEnchantments == null) {
            ...
            ItemStack[] items = { new ItemStack(BetterStorageItems.cardboardHelmet),
        ...
        if (stack.getItem() instanceof ItemEnchantedBook) {
            ...
            for (Enchantment ench : validEnchantments) if (enchants.containsKey(ench.effectId)) return true;
        }
        return false;
    }
