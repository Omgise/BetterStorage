...
public class MTCraftingStation {
    ...
    @ZenMethod
    public static void addShaped(IItemStack[] output, IIngredient[][] input, @Optional int experience,
        @Optional int craftingTime) {
    ...
    @ZenMethod
    public static void addShapedMirrored(IItemStack[] output, IIngredient[][] input, @Optional int experience,
        @Optional int craftingTime) {
    ...
    private static void addShaped(IItemStack[] output, IIngredient[][] input, int experience, int craftingTime,
        boolean mirrored) {
    ...
    @ZenMethod
    public static void addShapeless(IItemStack[] output, IIngredient[] input, @Optional int experience,
        @Optional int craftingTime) {
        ItemStack[] recipeOutput = MTHelper.toStacks(output);
    ...
    private static class UndoableRecipeAddAction implements IUndoableAction {
        ...
        public String describe() {
            return "Adding crafting station recipe for " + desc;
        }

        @Override
        public String describeUndo() {
            return "Removing crafting station recipe for " + desc;
        }
        ...
        @Override
        public void undo() {
            BetterStorageCrafting.recipes.remove(recipe);
        }
