...
public class ItemThaumcraftBackpack extends ItemBackpack implements IRepairable, IVisDiscountGear {
    ...
    public void onEquippedUpdate(EntityLivingBase entity, ItemStack backpack) {
        ...
        if (!entity.worldObj.isRemote && (entity instanceof EntityPlayer)) repairItems(backpack, (EntityPlayer) entity);
    }
     ...
     * int auraId = ThaumcraftApi.getClosestAuraWithinRange(player.worldObj, player.posX, player.posY, player.posZ,
     * 640);
     * if (auraId == -1) return;
