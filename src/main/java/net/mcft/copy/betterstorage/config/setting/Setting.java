    ...
    public void validate() {
        ...
        if (warning != null) {
            ...
            BetterStorage.log.warn(
                String.format(
                    "Config setting %s is invalid: %s. Using default value: %s.",
                    fullName,
                    warning,
                    defaultValue));
        }
