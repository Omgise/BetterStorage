...
public class PresentRecipe extends ShapedRecipes {
    ...
    public ItemStack getCraftingResult(InventoryCrafting crafting) {
        ...
        NBTTagCompound compound = (NBTTagCompound) box.getTagCompound()
            .copy();
    ...
    private static int checkWoolColor(InventoryCrafting crafting, int... slots) {
        ...
        for (int i = 0; i < slots.length; i++) {
            ...
            else if (stack.getItem() == Item.getItemFromBlock(Blocks.wool)) woolColor = stack.getItemDamage();
            else if (stack.getItem() == Item.getItemFromBlock(Blocks.gold_block)) woolColor = 16;
            else return -1;
