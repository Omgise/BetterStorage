...
public class ItemDrinkingHelmet extends ItemArmorBetterStorage {
    ...
    public static final ArmorMaterial material = EnumHelper
        .addArmorMaterial("drinkingHelmet", 11, new int[] { 3, 0, 0, 0 }, 15);
    static {
    ...
    public void addInformation(ItemStack stack, EntityPlayer player, List list, boolean advancedTooltips) {
        ...
        for (ItemStack potion : getPotions(stack)) {
            ...
            if ((list.size() > 0) && (list.get(list.size() - 1)
                .equals(EnumChatFormatting.DARK_AQUA + name)))
    ...
    public static ItemStack getDrinkingHelmet(EntityLivingBase entity) {
        ...
        if ((drinkingHelmet != null) && (drinkingHelmet.getItem() instanceof ItemDrinkingHelmet)) return drinkingHelmet;
        else return null;
    }
    ...
    public static void use(EntityPlayer player) {
        ...
        for (ItemStack item : potions) if (item.getItem() instanceof ItemPotion) {
            ...
            if (effects != null) potionEffects.addAll(effects);
        }
