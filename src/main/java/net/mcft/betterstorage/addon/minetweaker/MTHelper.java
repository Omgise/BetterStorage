...
public final class MTHelper {
    ...
    public static ItemStack toStack(IItemStack stack) {
        if (stack == null) return null;
            ...
            MineTweakerAPI.getLogger()
                .logError("Not a valid item stack: " + stack);
            return null;
    ...
    public static ItemStack[] toStacks(IItemStack[] mtStacks) {
        ...
        for (int i = 0; i < stacks.length; i++) stacks[i] = toStack(mtStacks[i]);
        return stacks;
    }
    ...
    public static List<ItemStack> toStacks(List<IItemStack> mtStacks) {
        ...
        ItemStack stack;
        for (IItemStack mtStack : mtStacks) if ((stack = toStack(mtStack)) != null) stacks.add(stack);
        return stacks;
    }
