...
public class ThaumcraftAddon extends Addon {
    ...
    public void addRecipes() {
        ...
        if ((thaumcraftBackpack != null) && (BetterStorageTiles.backpack != null)) {
            thaumcraftBackpackRecipe = ThaumcraftApi.addInfusionCraftingRecipe(
                "betterstorage.magicstorage",
                new ItemStack(itemThaumcraftBackpack),
                1,
        ...
        if ((thaumiumChest != null) && (BetterStorageTiles.reinforcedChest != null)) {
            thaumiumChestRecipe = ThaumcraftApi.addInfusionCraftingRecipe(
                "betterstorage.magicstorage",
                new ItemStack(thaumiumChest),
                4,
    ...
    private void addItemAspects() {
        ...
        addAspectsFor(
            BetterStorageItems.itemEnderBackpack,
            -1,
            true,
            Aspect.DARKNESS,
            8,
        ...
        addAspectsFor(
            BetterStorageItems.drinkingHelmet,
            -1,
            true,
            Aspect.ARMOR,
            2,
    ...
    public static AspectList createAspectList(Object... aspects) {
        ...
        for (int i = 0; i < aspects.length; i += 2) list.add((Aspect) aspects[i], (Integer) aspects[i + 1]);
        return list;
    }
    ...
    public void registerRenderers() {
        if (thaumcraftBackpack != null) MinecraftForgeClient
            .registerItemRenderer(itemThaumcraftBackpack, new ItemRendererBackpack(TileEntityBackpack.class));
        if (thaumiumChest != null) thaumiumChestRenderId = ClientProxy
            .registerTileEntityRenderer(TileEntityThaumiumChest.class, new TileEntityReinforcedChestRenderer());
    }
    ...
    public void postInitialize() {
        ...
        if ((thaumcraftBackpack != null) || (thaumiumChest != null)) {
            ...
            if (thaumcraftBackpack != null && thaumcraftBackpackRecipe != null)
            ...
            ResearchItem research = new ResearchItem(
                ...
                2,
                new ItemStack(
                    ((thaumcraftBackpack != null) ? itemThaumcraftBackpack : Item.getItemFromBlock(thaumiumChest))))
