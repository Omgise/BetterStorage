...
public class InventoryBackpackEquipped extends InventoryWrapper {
    ...
    public boolean isUseableByPlayer(EntityPlayer player) {
        ...
        double direction = DirectionUtils
            .angleDifference(carrier.renderYawOffset + 90.0F, DirectionUtils.angleBetween(carrier, player));
        return (carrier.isEntityAlive() && carriesBackpack && ((distance < 2) && (Math.abs(direction) > 135))
            || (carrier == player));
    }
