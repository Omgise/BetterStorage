...
public abstract class TileEntityContainer extends TileEntity {
    ...
    public void setCustomTitle(String title) {
        if (canSetCustomTitle()) customTitle = title;
    }
    ...
    public void openGui(EntityPlayer player) {
        ...
        PlayerUtils
            .openGui(player, getName(), container.getColumns(), container.getRows(), getCustomTitle(), container);
    }
    ...
    public void onNeighborUpdate(Block neighborBlock) {
        if (acceptsRedstoneSignal() && neighborBlock.canProvidePower()) checkForRedstoneChange();
    }
    ...
    public void markDirtySuper() {
        ...
        if (hasComparatorAccessed()) markContentsChanged();
    }
    ...
    public void readFromNBT(NBTTagCompound compound) {
        ...
        if (contents != null) NbtUtils.readItems(contents, compound.getTagList("Items", NBT.TAG_COMPOUND));
        if (compound.getBoolean("ComparatorAccessed")) compAccessedOnLoad = true;
        if (acceptsRedstoneSignal()) redstonePower = compound.getByte("RedstonePower");
    }
    ...
    public void writeToNBT(NBTTagCompound compound) {
        ...
        if (acceptsRedstoneSignal()) compound.setByte("RedstonePower", (byte) redstonePower);
    }
