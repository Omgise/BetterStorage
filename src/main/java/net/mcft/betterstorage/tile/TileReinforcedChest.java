...
import net.mcft.betterstorage.item.tile.ItemLockable;
...
public class TileReinforcedChest extends TileLockable {
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess world, int x, int y, int z) {
        ...
        if (chest.isConnected()) {
            ...
            if (connected == ForgeDirection.NORTH) setBlockBounds(0.0625F, 0.0F, 0.0F, 0.9375F, 0.875F, 0.9375F);
            else if (connected == ForgeDirection.SOUTH) setBlockBounds(0.0625F, 0.0F, 0.0625F, 0.9375F, 0.875F, 1.0F);
            else if (connected == ForgeDirection.WEST) setBlockBounds(0.0F, 0.0F, 0.0625F, 0.9375F, 0.875F, 0.9375F);
            else if (connected == ForgeDirection.EAST) setBlockBounds(0.0625F, 0.0F, 0.0625F, 1.0F, 0.875F, 0.9375F);
