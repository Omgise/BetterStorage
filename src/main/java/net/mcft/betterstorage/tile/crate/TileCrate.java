...
public class TileCrate extends TileContainerBetterStorage implements ILaputaImmobile {
    ...
    public void onBlockPlacedExtended(World world, int x, int y, int z, int side, float hitX, float hitY, float hitZ,
        EntityLivingBase entity, ItemStack stack) {
        TileEntityCrate crate = WorldUtils.get(world, x, y, z, TileEntityCrate.class);
        if (stack.hasDisplayName()) crate.setCustomTitle(stack.getDisplayName());
        crate.attemptConnect(
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX,
        ...
        WorldUtils.get(world, x, y, z, TileEntityCrate.class)
            .openGui(player);
        return true;
    }
    ...
    private class ConnectedTextureCrate extends ConnectedTexture {
        ...
        @Override
        public boolean canConnect(IBlockAccess world, int x, int y, int z, ForgeDirection side,
