...
import net.mcft.betterstorage.item.cardboard.CardboardEnchantmentRecipe;
import net.mcft.betterstorage.item.cardboard.CardboardRepairRecipe;
import net.mcft.betterstorage.item.recipe.DrinkingHelmetRecipe;
import net.mcft.betterstorage.item.recipe.DyeRecipe;
import net.mcft.betterstorage.item.recipe.KeyRecipe;
import net.mcft.betterstorage.item.recipe.LockColorRecipe;
import net.mcft.betterstorage.item.recipe.LockRecipe;
import net.mcft.betterstorage.item.recipe.PresentRecipe;
import net.mcft.betterstorage.item.recipe.PresentRemoveNametagRecipe;
...
public final class Recipes {
    ...
    private static void addTileRecipes() {
        ...
        // Crate recipe
        if (BetterStorageTiles.crate != null) GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(BetterStorageTiles.crate),
                "o/o",
                "/ /",
                "o/o",
                'o',
        ...
        if (BetterStorageTiles.locker != null) {
            GameRegistry.addRecipe(
                new ShapedOreRecipe(
                    new ItemStack(BetterStorageTiles.locker),
                    "ooo",
                    "o |",
                    "ooo",
                    'o',
            ...
            if (BetterStorageTiles.reinforcedLocker != null)
                for (ContainerMaterial material : ContainerMaterial.getMaterials()) {
                    IRecipe recipe = material
                        .getReinforcedRecipe(BetterStorageTiles.locker, BetterStorageTiles.reinforcedLocker);
                    if (recipe != null) GameRegistry.addRecipe(recipe);
                }
        }

        // Armor stand recipe
        if (BetterStorageTiles.armorStand != null) GameRegistry.addShapedRecipe(
            new ItemStack(BetterStorageTiles.armorStand),
            " i ",
            "/i/",
            " s ",
            's',
        ...
        // Backpack recipe
        if (BetterStorageTiles.backpack != null) GameRegistry.addShapedRecipe(
        ...
        if ((BetterStorageTiles.cardboardBox != null) && (BetterStorageItems.cardboardSheet != null))
            GameRegistry.addRecipe(
                new ShapedOreRecipe(
                    new ItemStack(BetterStorageTiles.cardboardBox),
                    "ooo",
                    "o o",
                    "ooo",
                    'o',
        ...
        if (BetterStorageTiles.craftingStation != null) GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(BetterStorageTiles.craftingStation),
                "B-B",
                "PTP",
                "WCW",
                'B',
                ...
                "plankWood",
                'C',
                ((BetterStorageTiles.crate != null) ? BetterStorageTiles.crate : Blocks.chest)));
        ...
        if (BetterStorageTiles.flintBlock != null) {
            GameRegistry
                .addShapedRecipe(new ItemStack(BetterStorageTiles.flintBlock), "ooo", "ooo", "ooo", 'o', Items.flint);
    ...
    private static void addItemRecipes() {
        ...
        if (BetterStorageItems.key != null) {
            ...
            GameRegistry
                .addRecipe(KeyRecipe.createKeyRecipe(".o", ".o", " o", 'o', Items.gold_ingot, '.', Items.gold_nugget));
            // Key modify recipe
        ...
        if (BetterStorageItems.lock != null) {
            // Lock recipe
            if (BetterStorageItems.key != null) GameRegistry.addRecipe(LockRecipe.createLockRecipe());
            // Lock color recipe
            GameRegistry.addRecipe(LockColorRecipe.createLockColorRecipe());
        }

        // Keyring recipe
        if (BetterStorageItems.keyring != null) GameRegistry
            .addShapedRecipe(new ItemStack(BetterStorageItems.keyring), "...", ". .", "...", '.', Items.gold_nugget);
    ...
    private static void addCardboardRecipes() {
        ...
        if (BetterStorageItems.cardboardSheet != null) {
            GameRegistry.addShapelessRecipe(
                new ItemStack(BetterStorageItems.cardboardSheet, 4),
                Items.paper,
                Items.paper,
                Items.paper,
                Items.paper,
        ...
        if (BetterStorageItems.cardboardHelmet != null) GameRegistry.addRecipe(
            new ShapedOreRecipe(
        ...
        if (BetterStorageItems.cardboardChestplate != null) GameRegistry.addRecipe(
            new ShapedOreRecipe(
        ...
        if (BetterStorageItems.cardboardLeggings != null) GameRegistry.addRecipe(
            new ShapedOreRecipe(
        ...
        if (BetterStorageItems.cardboardBoots != null) GameRegistry.addRecipe(
            new ShapedOreRecipe(new ItemStack(BetterStorageItems.cardboardBoots), "o o", "o o", 'o', "sheetCardboard"));

        // Cardboard sword recipe
        if (BetterStorageItems.cardboardSword != null) GameRegistry.addRecipe(
            new ShapedOreRecipe(
        ...
        if (BetterStorageItems.cardboardPickaxe != null) GameRegistry.addRecipe(
            new ShapedOreRecipe(
        ...
        if (BetterStorageItems.cardboardShovel != null) GameRegistry.addRecipe(
            new ShapedOreRecipe(
