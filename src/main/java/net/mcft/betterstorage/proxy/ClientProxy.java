package net.mcft.betterstorage.proxy;

import java.util.HashMap;
import java.util.Map;

import net.mcft.betterstorage.addon.Addon;
import net.mcft.betterstorage.api.stand.ArmorStandEquipHandler;
import net.mcft.betterstorage.api.stand.BetterStorageArmorStand;
import net.mcft.betterstorage.api.stand.EnumArmorStandRegion;
import net.mcft.betterstorage.attachment.Attachment;
import net.mcft.betterstorage.attachment.Attachments;
import net.mcft.betterstorage.attachment.IHasAttachments;
import net.mcft.betterstorage.client.model.ModelBackpackArmor;
import net.mcft.betterstorage.client.model.ModelCluckington;
import net.mcft.betterstorage.client.renderer.BetterStorageRenderingHandler;
import net.mcft.betterstorage.client.renderer.ItemRendererBackpack;
import net.mcft.betterstorage.client.renderer.ItemRendererCardboardBox;
import net.mcft.betterstorage.client.renderer.ItemRendererContainer;
import net.mcft.betterstorage.client.renderer.RenderFrienderman;
import net.mcft.betterstorage.client.renderer.TileEntityArmorStandRenderer;
import net.mcft.betterstorage.client.renderer.TileEntityBackpackRenderer;
import net.mcft.betterstorage.client.renderer.TileEntityLockableDoorRenderer;
...
import net.mcft.betterstorage.client.renderer.TileLockableDoorRenderingHandler;
...
import net.mcft.betterstorage.misc.handlers.KeyBindingHandler;
...
import net.mcft.betterstorage.tile.stand.VanillaArmorStandRenderHandler;
...
public class ClientProxy extends CommonProxy {
    ...
    public static final Map<Class<? extends TileEntity>, BetterStorageRenderingHandler> renderingHandlers = new HashMap<Class<? extends TileEntity>, BetterStorageRenderingHandler>();
    ...
    private void registerRenderers() {
        ...
        registerItemRenderer(
            BetterStorageTiles.reinforcedChest,
            new ItemRendererContainer(TileEntityReinforcedChest.class));
        registerItemRenderer(
            BetterStorageTiles.reinforcedLocker,
            new ItemRendererContainer(TileEntityReinforcedLocker.class));

        registerItemRenderer(
            BetterStorageTiles.cardboardBox,
            new ItemRendererCardboardBox(BetterStorageTiles.cardboardBox));
        ...
        RenderingRegistry
            .registerEntityRenderingHandler(EntityCluckington.class, new RenderChicken(new ModelCluckington(), 0.4F));

        reinforcedChestRenderId = registerTileEntityRenderer(
            TileEntityReinforcedChest.class,
        ...
        armorStandRenderId = registerTileEntityRenderer(
            TileEntityArmorStand.class,
            new TileEntityArmorStandRenderer(),
            false,
            0,
            1,
            0);
        backpackRenderId = registerTileEntityRenderer(
            TileEntityBackpack.class,
            new TileEntityBackpackRenderer(),
            true,
            -160,
            1.5F,
            0.14F);
        reinforcedLockerRenderId = registerTileEntityRenderer(
            TileEntityReinforcedLocker.class,
            new TileEntityLockerRenderer());
        lockableDoorRenderId = registerTileEntityRenderer(
            TileEntityLockableDoor.class,
            new TileEntityLockableDoorRenderer());
    ...
    public static void registerItemRenderer(Block block, IItemRenderer renderer) {
        if (block != null) MinecraftForgeClient.registerItemRenderer(Item.getItemFromBlock(block), renderer);
    }

    public static void registerItemRenderer(Item item, IItemRenderer renderer) {
        if (item != null) MinecraftForgeClient.registerItemRenderer(item, renderer);
    }

    public static int registerTileEntityRenderer(Class<? extends TileEntity> tileEntityClass,
        TileEntitySpecialRenderer renderer, boolean render3dInInventory, float rotation, float scale, float yOffset) {
        ClientRegistry.bindTileEntitySpecialRenderer(tileEntityClass, renderer);
        BetterStorageRenderingHandler renderingHandler = new BetterStorageRenderingHandler(
            tileEntityClass,
            renderer,
            render3dInInventory,
            rotation,
    ...
    public void drawBlockHighlight(DrawBlockHighlightEvent event) {
        ...
        if (block instanceof TileArmorStand) box = getArmorStandHighlightBox(player, world, x, y, z, target.hitVec);
    ...
    private AxisAlignedBB getArmorStandHighlightBox(EntityPlayer player, World world, int x, int y, int z,
        Vec3 hitVec) {
    ...
    public void onRenderPlayerSpecialsPre(RenderPlayerEvent.Specials.Pre event) {
        ...
        if (backpack != null) {
            ...
            if (color >= 0) {
                RenderUtils
                    .bindTexture(new ResourceLocation(backpackType.getArmorTexture(backpack, player, 0, "overlay")));
