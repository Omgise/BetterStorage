package net.mcft.betterstorage.client.renderer;
...
public class ItemRendererBackpack implements IItemRenderer {
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
        ...
        if (equippedThirdPerson) GL11.glScalef(1.2F, 1.2F, 1.2F);
        else if (entity) GL11.glScalef(0.75F, 0.75F, 0.75F);

        if (renderingHandler == null) renderingHandler = ClientProxy.renderingHandlers.get(tileEntityClass);
