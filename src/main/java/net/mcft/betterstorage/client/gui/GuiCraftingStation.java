...
public class GuiCraftingStation extends GuiBetterStorage {
    ...
    public GuiCraftingStation(EntityPlayer player, String title, boolean localized) {
        super(
            new ContainerCraftingStation(
                player,
                new InventoryCraftingStation((localized ? title : StatCollector.translateToLocal(title)))));
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        if (!inv.outputIsReal) for (int i = 9; i < 18; i++) {
            ...
            RenderUtils
                .drawTexturedModalRect(slotX, slotY, slotX, slotY, 16, 16, 0, getTextureWidth(), getTextureHeight());
