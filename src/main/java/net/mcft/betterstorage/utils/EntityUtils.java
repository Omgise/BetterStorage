...
public final class EntityUtils {
    ...
    public static String getIdentifier(Class<? extends IExtendedEntityProperties> propertiesClass) {
        ...
        if (identifier == null) {
            try {
                identifier = (String) propertiesClass.getField("identifier")
                    .get(null);
            } catch (Exception e) {
                throw new Error(e);
            }
    ...
    public static <T extends IExtendedEntityProperties> T createProperties(Entity entity, Class<T> propertiesClass) {
        try {
            T properties = propertiesClass.getConstructor()
                .newInstance();
    ...
    public static <T extends IExtendedEntityProperties> T getOrCreateProperties(Entity entity,
