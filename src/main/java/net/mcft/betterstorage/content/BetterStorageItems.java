...
import net.mcft.betterstorage.item.ItemPresentBook;
import net.mcft.betterstorage.item.cardboard.ItemCardboardArmor;
import net.mcft.betterstorage.item.cardboard.ItemCardboardAxe;
import net.mcft.betterstorage.item.cardboard.ItemCardboardHoe;
import net.mcft.betterstorage.item.cardboard.ItemCardboardPickaxe;
import net.mcft.betterstorage.item.cardboard.ItemCardboardSheet;
import net.mcft.betterstorage.item.cardboard.ItemCardboardShovel;
import net.mcft.betterstorage.item.cardboard.ItemCardboardSword;
import net.mcft.betterstorage.item.locking.ItemKey;
import net.mcft.betterstorage.item.locking.ItemKeyring;
import net.mcft.betterstorage.item.locking.ItemLock;
import net.mcft.betterstorage.item.locking.ItemMasterKey;
